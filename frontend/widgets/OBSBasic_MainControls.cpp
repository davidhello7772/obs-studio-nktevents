...
{
	char logDir[512];
	if (GetAppConfigPath(logDir, sizeof(logDir), "obs-12tracks-multilingual/logs") <= 0) {
		return;
	}
...
{
	const std::string userConfigPath = App()->userConfigLocation.u8string() + "/obs-12tracks-multilingual";
