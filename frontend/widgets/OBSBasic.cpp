...
static void AddExtraModulePaths()
{
...
#if defined(_WIN32)
	int ret = GetProgramDataPath(base_module_dir, sizeof(base_module_dir), "obs-12tracks-multilingual/plugins/%module%");
#elif defined(__APPLE__)
	int ret = GetAppConfigPath(base_module_dir, sizeof(base_module_dir), "obs-12tracks-multilingual/plugins/%module%.plugin");
#else
	int ret = GetAppConfigPath(base_module_dir, sizeof(base_module_dir), "obs-12tracks-multilingual/plugins/%module%");
#endif
	...
	GetProgramDataPath(system_legacy_module_dir, sizeof(system_legacy_module_dir), "obs-12tracks-multilingual/plugins/%module%");
	...
	GetAppConfigPath(user_legacy_module_dir, sizeof(user_legacy_module_dir), "obs-12tracks-multilingual/plugins/%module%");
