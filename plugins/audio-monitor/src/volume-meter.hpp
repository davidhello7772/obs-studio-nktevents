 ...
 * Adapted from OBS Studio frontend/widgets/VolumeMeter.hpp
...
class VolumeMeter : public QWidget {
	...
	// Quiet zone colors (below nominal level - "too quiet")
	Q_PROPERTY(QColor backgroundQuietColor READ getBackgroundQuietColor WRITE setBackgroundQuietColor DESIGNABLE true)
	Q_PROPERTY(QColor foregroundQuietColor READ getForegroundQuietColor WRITE setForegroundQuietColor DESIGNABLE true)
	...
	Q_PROPERTY(qreal nominalLevel READ getNominalLevel WRITE setNominalLevel DESIGNABLE true)
...
private:
	...
	QColor backgroundQuietColor;
	QColor foregroundQuietColor;
...
public:
	...
	QColor getBackgroundQuietColor() const;
	void setBackgroundQuietColor(QColor c);
	QColor getForegroundQuietColor() const;
	void setForegroundQuietColor(QColor c);
	...
	qreal getNominalLevel() const;
	void setNominalLevel(qreal v);
...
// Timer for updating volume meters
