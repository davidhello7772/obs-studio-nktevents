  ...
  if(target_type STREQUAL EXECUTABLE)
    if(target STREQUAL obs-studio)
      set_target_properties(
        ${target}
        PROPERTIES
          OUTPUT_NAME "12 Tracks Multilingual"
          MACOSX_BUNDLE TRUE
      ...
      set_target_xcode_properties(
        ${target}
        PROPERTIES PRODUCT_BUNDLE_IDENTIFIER com.12tracksmultilingual.obs-12tracks-multilingual
                   PRODUCT_NAME "12 Tracks Multilingual"
                   ...
                   INFOPLIST_KEY_CFBundleDisplayName "12 Tracks Multilingual"
                   INFOPLIST_KEY_NSHumanReadableCopyright "(c) 2012-${CURRENT_YEAR} Lain Bailey"
                   INFOPLIST_KEY_NSCameraUsageDescription "12 Tracks Multilingual needs to access the camera to enable camera sources to work."
                   INFOPLIST_KEY_NSMicrophoneUsageDescription "12 Tracks Multilingual needs to access the microphone to enable audio input."
                   INFOPLIST_KEY_NSAppleEventsUsageDescription "12 Tracks Multilingual needs to access background events to enable hotkeys while not in focus."
      )
  ...
  elseif(target_type STREQUAL SHARED_LIBRARY)
    ...
    set_target_xcode_properties(
      ...
      PROPERTIES DYLIB_COMPATIBILITY_VERSION 1.0
                 ...
                 PRODUCT_NAME ${target}
                 PRODUCT_BUNDLE_IDENTIFIER com.12tracksmultilingual.${target}
                 SKIP_INSTALL YES
    )
    ...
    if(is_framework)
      set_target_properties(
        ${target}
        PROPERTIES FRAMEWORK_VERSION A MACOSX_FRAMEWORK_IDENTIFIER com.12tracksmultilingual.${target}
      )
